...
```{r echo=FALSE, out.width = '90%', retina = 3}
...
```{r echo=FALSE, out.width = '90%', retina = 3}
knitr::include_graphics('./files/f_comp_7.jpeg')
```
...
```{r , echo=FALSE, eval=TRUE, out.width = '90%', retina = 3}
...
```{r , echo=FALSE, eval=TRUE, out.width = '95%', retina = 3}
...
```{r echo=FALSE, out.width = '35%', retina = 3}
...
```{r echo=FALSE, out.width = '60%', retina = 3}
